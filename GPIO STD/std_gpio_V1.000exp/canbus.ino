...
void canbroadcastperfreq(byte freqcheck)
{
  ...
  if(BIT_sCHECK(configPage3.canbroadcast_config, 3) == 1)       //remote inputs 0-15
    { 
     //byte RIchan = 1;
  ...
  if(BIT_sCHECK(configPage3.canbroadcast_config, 4) == 1)     // remote inputs 16-31
    {
 ...
 currentStatus.dev2 = freqcheck;
  ...
  if(BIT_sCHECK(configPage3.canbroadcast_config, 5) == 1)       //remote Ainputs 0-15
    { 
     //byte RIchan = 1;
     for(byte RIchan = 0; RIchan <16 ; RIchan++)
        { 
...
void obd_command(byte usecan)
{
    ...
    obd_response(rxBuf[2]);
            ...
            Send_CAN0_message(0xFF,configPage3.gpio_obd_address,obddata);
    #endif
    
    #if defined OBD_CANPORT == 1    //use can1 to send obd data stream
            Send_CAN1_message(0xFF,configPage3.gpio_obd_address,obddata);
    #endif
