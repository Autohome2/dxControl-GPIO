...
void direct_sendValues(uint16_t offset, uint16_t packetLength, uint8_t cmd)
{
  ...
  fullStatus[17] = lowByte(currentStatus.Analog[1]);
  fullStatus[18] = highByte(currentStatus.Analog[1]);
  fullStatus[19] = lowByte(currentStatus.Analog[2]);
  fullStatus[20] = highByte(currentStatus.Analog[2]);
  fullStatus[21] = lowByte(currentStatus.Analog[3]);
  fullStatus[22] = highByte(currentStatus.Analog[3]);
  fullStatus[23] = lowByte(currentStatus.Analog[4]);
  fullStatus[24] = highByte(currentStatus.Analog[4]);  
  fullStatus[25] = lowByte(currentStatus.Analog[5]);
  fullStatus[26] = highByte(currentStatus.Analog[5]);
  fullStatus[27] = lowByte(currentStatus.Analog[6]);
  fullStatus[28] = highByte(currentStatus.Analog[6]);
  fullStatus[29] = lowByte(currentStatus.Analog[7]);
  fullStatus[30] = highByte(currentStatus.Analog[7]);
  fullStatus[31] = lowByte(currentStatus.Analog[8]);
  fullStatus[32] = highByte(currentStatus.Analog[8]);
  fullStatus[33] = lowByte(currentStatus.Analog[9]);
  fullStatus[34] = highByte(currentStatus.Analog[9]);
  fullStatus[35] = lowByte(currentStatus.Analog[10]);
  fullStatus[36] = highByte(currentStatus.Analog[10]);
  fullStatus[37] = lowByte(currentStatus.Analog[11]);
  fullStatus[38] = highByte(currentStatus.Analog[11]);
  fullStatus[39] = lowByte(currentStatus.Analog[12]);
  fullStatus[40] = highByte(currentStatus.Analog[12]);  
  fullStatus[41] = lowByte(currentStatus.Analog[13]);
  fullStatus[42] = highByte(currentStatus.Analog[13]);
  fullStatus[43] = lowByte(currentStatus.Analog[14]);
  fullStatus[44] = highByte(currentStatus.Analog[14]);
  fullStatus[45] = lowByte(currentStatus.Analog[15]);
  fullStatus[46] = highByte(currentStatus.Analog[15]);
  fullStatus[47] = lowByte(currentStatus.Analog[16]);
  fullStatus[48] = highByte(currentStatus.Analog[16]);    
